...
namespace rum
{
    ...
    RequestIntRedirFiltCond::RequestIntRedirFiltCond(apr_pool_t *p,
                                                     const
                                                     RequestIntRedirFiltCond&
                                                     from)
        : FiltCond(p, from),
          isIntRedir_(from.isIntRedir_),
    ...
    RequestIntRedirFiltCond::~RequestIntRedirFiltCond()
    { }
    ...
    StrBuffer& RequestIntRedirFiltCond::write(StrBuffer& sb) const
    {
        return sb << asStr();
    }
    ...
    const char *RequestIntRedirFiltCond::condName_ = "Request";
}
